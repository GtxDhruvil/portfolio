...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden px-[5%] sm:px-[5%] lg:px-[10%]">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              >
                <CTAButton
                  ...
                  icon={ExternalLink}
                />
                <CTAButton to="/contact" text="Contact" icon={Mail} />
              </div>
          ...
          >
            <div className="relative w-full opacity-90">
              ...
              >
                <DotLottieReact src="https://lottie.host/58753882-bb6a-49f5-a2c0-950eda1e135a/NLbpVqGegK.lottie" loop autoplay className="w-full h-full object-cover" />
              </div>
