...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/dhruvil-patel-2a2805256/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@dhruvil_201",
    icon: Instagram,
    url: "https://www.instagram.com/dhruvil_201/",
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@Dhruvil Patel",
    icon: Github,
    url: "https://github.com/GtxDhruvi",
    color: "#ffffff",
    ...
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
          {[github].filter(Boolean).map((link, index) => (
            <a
              key={link.name}
              href={link.url}
              target="_blank"
